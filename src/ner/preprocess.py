...
from configuration.config import RAW_DATA_FILE, MODEL_NAME, PROCESSED_DATA_DIR, LABELS
...
def process():
    ...
    test_valid_dict = dataset_dict['test'].train_test_split(test_size=0.5, seed=42)
    dataset_dict['test'] = test_valid_dict['train']
    dataset_dict['valid'] = test_valid_dict['test']
